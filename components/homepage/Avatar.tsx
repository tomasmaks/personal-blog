...
const Avatar = () => {
  ...
  return (
    <div
      className="z-1 hover:z-2 scale-100 transition-all duration-200 ease-out hover:scale-[1.02] min-w-[400px]"
      style={{ perspective: '800px' }}
      ref={ref}
    >
      <div style={style} className="max-h-[430px] overflow-hidden rounded-md transition-all duration-200 ease-out">
        <Image src={siteMetadata.avatar} alt="avatar" width={430} height={430} />
      </div>
    </div>
  );
};
